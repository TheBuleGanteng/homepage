...
"""
Django settings for Homepage_2.0.
...
ALLOWED_HOSTS = ['127.0.0.1', '35.192.68.175', 'localhost'] # Must update prior to prod
...
logger.debug(f'running settings.py ... PROJECT_ENV is: { PROJECT_ENV }')
logger.debug(f'running settings.py ... ALLOWED_HOSTS is: { ALLOWED_HOSTS }')
logger.debug(f'running settings.py ... DEBUG is: { DEBUG }')
